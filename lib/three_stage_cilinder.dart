...
class ThreeStageCilinder extends StatefulWidget {
  const ThreeStageCilinder({Key? key}) : super(key: key);

  @override
  State<ThreeStageCilinder> createState() => _ThreeStageCilinderState();
}

class _ThreeStageCilinderState extends State<ThreeStageCilinder> {
